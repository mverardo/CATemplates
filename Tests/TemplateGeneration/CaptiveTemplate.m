...
Print[CaptiveTemplate[2, 1] === {1, x6, x5, x4, x3, x2, x1, 0}]


Print[CaptiveTemplate[3, 1] === {2, x25 \[Element] {1, 2}, 
  ...
  x3 \[Element] {0, 1}, x2 \[Element] {0, 2}, x1 \[Element] {0, 1}, 0}]


Print[
  CaptiveTemplate[3, 2] === {2, x241 \[Element] {1, 2}, 
