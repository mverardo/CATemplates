...
Print[ExpandTemplate[BaseTemplate[]] === Tuples[{0, 1}, 8]]


Print[ExpandTemplate[BaseTemplate[], 2, 0] === {0, 0, 0, 0, 0, 0, 0, 0}]


Print[ExpandTemplate[BaseTemplate[], 2, 4] === {0, 0, 0, 0, 0, 1, 0, 0}]
...
Print[ExpandTemplate[BaseTemplate[], 2, {0, 4}] === Tuples[{0, 1}, 8][[1 ;; 5]]]
